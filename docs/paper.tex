...
praktiniam panaudojimui, kritiškai įvertinamas praktinis įrankio panaudojimas.
...
\item Apžvelgus literatūrą parinkti klasifikavimo modeliai ir pasiūlytas PageRank įverčio naudojimas kenksmingų interneto tinklalapių identifikavimo modelyje;
\item Suformuotas modelis kurio tikslumas 97.5 \%;
\item Sukurta kenksmingų interneto tinklalapių identifikavimo programa kuri gali būti lengvai modifikuojama, tiksliai identifikuoja kenksmingus tinklalapius, pagal validavimo imtį, tačiau klaidingai identifikuoja tam tikrus tinklalapius;
\item ateityje siūloma tobulinti programą į klasifikuojamų objektų požymius įtraukiant tinklalapių turinį bei serverių informaciją atspindinčius parametrus.
\end{enumerate}
