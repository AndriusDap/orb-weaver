...
\ktusubsection{Socialinė inžinerija}
...
\ktusubsection{Kenkimo programos}

\ktusubsection{Nepageidaujama programinė įranga}

\ktusubsection{Potencialiai žalinga programinė įranga}


\ktusection{Pavojingų svetainių aptikimas}
