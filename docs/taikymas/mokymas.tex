...
\ktufigure{images/svm_sux.png}{14 cm}{Klasifikatoriaus logistinių nuostolių priklausomybė nuo mokymo duomenų kiekio}
...
\ktufigure{images/linear_loss.png}{12 cm}{Tiesinio branduolio modelio nuostolių ir mokymo duomenų kiekio priklausomybė}
\ktufigure{images/polly_loss.png}{12 cm}{Polinominio branduolio modelio nuostolių ir mokymo duomenų kiekio priklausomybė}
\ktufigure{images/rbf_loss.png}{12 cm}{Radialinės bazės funkcijos branduolio modelio nuostolių ir mokymo duomenų kiekio priklausomybė}

Naudojant kitus branduolio tipus ir logistinę nuostolių funkciją pastebėta ta pati tendencija, matoma \ktufigref{images/linear_loss.png} - \ktufigref{images/rbf_loss.png}.
...
\ktufigure{images/linearModelLoss.png}{14 cm}{Logistinės regresijos modelio nuostolių priklausomybė nuo mokymo duomenų kiekio}
...
\ktufigure{images/treeLoss.png}{12 cm}{Sprendimų medžio modelio nuostolių priklausomybė nuo mokymo duomenų kiekio}
