...
\ktufigure{images/linear_loss.png}{12 cm}{Tiesinio branduolio modelio nuostolių ir mokymo pavyzdžių santykis}
\ktufigure{images/polly_loss.png}{12 cm}{Polinominio branduolio modelio nuostolių ir mokymo pavyzdžių santykis}
\ktufigure{images/rbf_loss.png}{12 cm}{Radialinės bazės funkcijos branduolio modelio nuostolių ir mokymo pavyzdžių santykis}
...
Modelio mokymo nuostoliai pateikiami paveiksle \ktufigref{images/linearModelLoss.png}. Šiame grafike
...
\ktufigure{images/linearModelLoss.png}{14 cm}{Tiesinės regresijos modelio nuostolių priklausomybė nuo mokymo pavyzdžių}
...
\ktufigure{images/treeLoss.png}{12 cm}{Sprendimų medžio modelio nuostolių priklausomybė nuo pavyzdžių skaičiaus}
