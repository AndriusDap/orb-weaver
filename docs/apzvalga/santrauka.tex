...
Darbo tikslas -- pasiūlyti metodiką ir sukurti įrankį kenksmingų ir nekenksmingų tinklalapių klasifikavimui, kur kenksmingi tinklalapiai yra pavojingų tinklalapių sąrašuose aptinkami adresai.

Sprendžiami uždaviniai:
\begin{enumerate}
    \item klasifikavimo modelių bei sąvybių vektoriaus formavimo metodo parinkimas;
    \item metodikos klasifikavimo uždaviniui spręsti sukūrimas;
    \item programinio įrankio klasifikavimui kūrimas;
    \item pritaikymas naudojant realų duomenų rinkinį.
\end{enumerate}
