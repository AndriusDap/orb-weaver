...
\ktusubsubsection{K-Artimiausų kaimynų (K-Nearest neighbours)}



\ktusubsubsection{Atramos vektorių mašinų (Support Vector Machine)}


\ktusubsubsection{Paprastasis Bayes klasifikatorius (Naive Bayes)}


\ktusubsubsection{K-Vidurkių (K-Means)}
